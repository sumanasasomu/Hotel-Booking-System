 ...
 * @author RAHUL
 */
public class WLnumDisplay extends javax.swing.JFrame {

    /**
     * Creates new form lf_fromWLnumDisplay
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("We have put you in waiting list");
        ...
        jPanel2.setLayout(new java.awt.GridLayout(6, 2, 20, 0));

        jLabel2.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 0));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel2.setText("Waiting List No.");
        jPanel2.add(jLabel2);

        Lbid.setForeground(new java.awt.Color(255, 102, 0));
        Lbid.setText(Integer.toString(gv.getWnum()));
        jPanel2.add(Lbid);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Welcome w_fromWLnumDisplay = new Welcome();
        w_fromWLnumDisplay.setVisible(true);
        w_fromWLnumDisplay.pack();
        w_fromWLnumDisplay.setLocationRelativeTo(null);
        dispose();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        LoginForm lf_fromWLnumDisplay = new LoginForm();
        lf_fromWLnumDisplay.setVisible(true);
        lf_fromWLnumDisplay.pack();
        lf_fromWLnumDisplay.setLocationRelativeTo(null);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WLnumDisplay.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WLnumDisplay().setVisible(true);
            }
        });
    }
