 ...
 * @author RAHUL
 */
public class EndBooking_w extends javax.swing.JFrame {
    GlobalVariables gv = GlobalVariables.getinstance();
    /**
     * Creates new form EndBooking_w
     */
    public EndBooking_w() {
        initComponents();
    ...
    private void initComponents() {
        ...
        Lhname.setText(gv.getHotelname_w());
        jPanel2.add(Lhname);
        ...
        Lpeople.setText(Integer.toString(gv.getPersons_w()));
        jPanel2.add(Lpeople);
        ...
        Lrooms.setText(Integer.toString(gv.getRooms_w()));
        jPanel2.add(Lrooms);
        ...
        Ltprice.setText("Rs."+gv.getTotalPrice_w());
        jPanel2.add(Ltprice);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EndBooking_w.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EndBooking_w().setVisible(true);
            }
        });
    }
